...
data class TourDetailContent(
    ...
    @SerializedName("sponsor1") val sponsor1: String?,
    @SerializedName("sponsor1tel") val sponsor1tel: String?,
    ...
    @SerializedName("chkbabycarriageleports") val chkbabycarriageleports: String?,
    @SerializedName("chkcreditcardleports") val chkcreditcardleports: String?,
    @SerializedName("chkpetleports") val chkpetleports: String?,
    ...
    @SerializedName("chkbabycarriageshopping") val chkbabycarriageshopping: String?,
    @SerializedName("chkcreditcardshopping") val chkcreditcardshopping: String?,
    @SerializedName("chkpetshopping") val chkpetshopping: String?,
    ...
    @SerializedName("restroom") val restroom: String?,
